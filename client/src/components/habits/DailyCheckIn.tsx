...
export function DailyCheckIn({ date, onChange }: { date: string; onChange: (date: string) => void }) {
  ...
  return (
    <div className="space-y-6">
      ...
      >
        ...
        {streak > 0 && (
          <div className="mt-3 inline-flex items-center gap-1.5 text-sm font-medium text-orange-400 bg-orange-500/10 px-3 py-1 rounded-full">
      ...
      <div>
        ...
        {habitsLoading || todayLoading ? (
          <div className="flex justify-center py-10">
            <Loader2 className="w-5 h-5 animate-spin text-gray-500" />
          </div>
        ) : activeHabits.length === 0 ? (
          <div className="text-center text-gray-500 py-10 bg-gray-800 rounded-2xl border border-gray-700">
            <p>No habits yet</p>
