...
import { HabitFrequency, HabitSection } from '@/types';
...
export function AddHabitForm() {
  ...
  const [goalType, setGoalType] = useState<'simple' | 'time'>('time');
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="bg-gray-800 rounded-3xl border border-gray-700 p-6 space-y-5">
      ...
      <div className="grid grid-cols-2 gap-3">
        <div className="space-y-2">
          ...
          <Select
            value={frequency}
            onValueChange={(v) => setValue('frequency', v as HabitFrequency, { shouldValidate: true })}
          >
        ...
        <div className="space-y-2">
          ...
          <Select value={section} onValueChange={(v) => setValue('section', v as HabitSection, { shouldValidate: true })}>
            <SelectTrigger className="bg-gray-900 border-gray-700 text-white">
              <SelectValue />
            </SelectTrigger>
            <SelectContent className="bg-gray-800 border-gray-700 text-white">
      ...
      <div className="space-y-3">
        ...
        {goalType === 'time' && (
          <Select value={String(goalSeconds)} onValueChange={(v) => setGoalSeconds(Number(v))}>
            <SelectTrigger className="bg-gray-900 border-gray-700 text-white">
              <SelectValue />
            </SelectTrigger>
            <SelectContent className="bg-gray-800 border-gray-700 text-white">
...
export function goalDisplay(goalType: string, dailyGoalSeconds: number): string {
